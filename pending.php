...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id === false || !in_array($kind, ['relationship', 'partnership'], true) || !in_array($action, ['approve', 'reject', 'withdraw'], true)) {
...
$incomingCount = count($pending['relationships']) + count($pending['partnerships']);
$outgoingCount = count($outgoing['relationships']) + count($outgoing['partnerships']);
?>
<!doctype html>
<html lang="en">
<head>
